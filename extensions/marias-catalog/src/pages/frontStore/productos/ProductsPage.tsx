    ...
    >
      <div className="grid grid-cols-5 gap-8">
        ...
        <div className="flex flex-col gap-3">
          <h3 className="font-semibold text-base" style={{ color: '#f0ece9' }}>
            Llámanos
          </h3>
          <a 
        ...
        <div className="flex flex-col gap-3">
          ...
          <p className="text-sm leading-relaxed" style={{ color: '#f0ece9' }}>
        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="flex flex-wrap gap-3">
            <a href="#" className="hover:opacity-70 transition-opacity">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="#f0ece9">
        ...
        <div className="flex flex-col gap-3">
          ...
          <a href="/procesos" className="text-sm hover:opacity-70 transition-opacity" style={{ color: '#f0ece9' }}>
            Procesos
          </a>
          <a href="/productos" className="text-sm hover:opacity-70 transition-opacity" style={{ color: '#f0ece9' }}>
            Productos
          </a>
          <a href="/recetas" className="text-sm hover:opacity-70 transition-opacity" style={{ color: '#f0ece9' }}>
            Recetas
          </a>
          <a href="/cliente" className="text-sm hover:opacity-70 transition-opacity" style={{ color: '#f0ece9' }}>
            Sé cliente
          </a>
        </div>
        ...
        <div className="flex flex-col gap-3">
          ...
          <a href="#ubicanos" className="text-sm hover:opacity-70 transition-opacity" style={{ color: '#f0ece9' }}>
            Ubícanos en
          </a>
          <a href="/contacto" className="text-sm hover:opacity-70 transition-opacity" style={{ color: '#f0ece9' }}>
            Contacto
          </a>
          
          <div className="mt-4 flex flex-col gap-2">
            <a href="/privacidad" className="text-xs hover:opacity-70 transition-opacity" style={{ color: '#f0ece9' }}>
              Política de Privacidad
            </a>
            <a href="/terminos" className="text-xs hover:opacity-70 transition-opacity" style={{ color: '#f0ece9' }}>
              Términos y Condiciones
            </a>
            <a href="/cookies" className="text-xs hover:opacity-70 transition-opacity" style={{ color: '#f0ece9' }}>
              Política de Cookies
            </a>
          </div>
        </div>
